...
@RestController
@RequestMapping("/api/jake-hipster-sample-application-kafka")
public class JakeHipsterSampleApplicationKafkaResource {

    private final Logger log = LoggerFactory.getLogger(JakeHipsterSampleApplicationKafkaResource.class);
    ...
    public JakeHipsterSampleApplicationKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
