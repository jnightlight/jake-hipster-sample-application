...
export default class JhiUserManagementComponent extends Vue {
  ...
  public deleteUser(): void {
    this.userManagementService()
      ...
      .then(res => {
        const message = this.$t(res.headers['x-jakehipstersampleapplicationapp-alert'], {
          param: decodeURIComponent(res.headers['x-jakehipstersampleapplicationapp-params'].replace(/\+/g, ' ')),
        });
